...
public class OI {
    ...
    JoystickButton hatchMotorReverse = new JoystickButton(joystick, RobotMap.JOYB_A);
    JoystickButton ballLiftUp = new JoystickButton(joystick, RobotMap.JOYB_LJ);
    JoystickButton ballLiftDown = new JoystickButton(joystick, RobotMap.JOYB_RJ);
