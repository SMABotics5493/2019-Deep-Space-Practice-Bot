...
public class OI {
    ...
    JoystickButton ballLiftUp = new JoystickButton(driveJoystick, RobotMap.JOYB_LT);
    JoystickButton ballLiftDown = new JoystickButton(driveJoystick, RobotMap.JOYB_RT);
